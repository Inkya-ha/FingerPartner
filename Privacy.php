...
<html lang="ja">
    ...
    <title>プライバシーポリシー｜FingerPartner</title>
    <style>
        /* CSS Document */
        /*-------------------------------*/
        div.wrapKOPIPE {
...
<body>
    ...
    <main>
        <p class="fs-1 label1">プライバシーポリシー</p>
        <div class="m-5">
            <div class="wrapKOPIPE">
                <div class="wrapHINAGATA text-left">
                    <h1 class="text-center">プライバシーポリシー</h1>
                    <p>FingerPartner（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                    <h2>第1条（個人情報）</h2>
                    ...
                    <p>
                        <br>運営統括責任者 : 
                        <br>メールアドレス : support@finger-partner.jp
                        <br><br>屋号 : FingerPartner
                    </p>
                    <p class="tR">以上</p>
                </div>
                <!--／wrapHINAGATA-->
