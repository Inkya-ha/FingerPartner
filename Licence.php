...
<html lang="ja">
    ...
    <title>利用規約｜FingerPartner</title>
    <style>
        /* CSS Document */
        /*-------------------------------*/
        div.wrapKOPIPE {
...
<body>
    ...
    <main>
        <p class="fs-1 label1">利用規約</p>
        <div class="m-5">
            <div class="wrapKOPIPE">
                <div class="wrapHINAGATA text-left">
                    <h1 class="text-center">利用規約</h1>
                    <p>この利用規約（以下，「本規約」といいます。）は，FingerPartner（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                    <h2>第1条（適用）</h2>
                    <ol>
